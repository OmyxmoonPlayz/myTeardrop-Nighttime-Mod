...
export function easeInElastic(elapsed, initialValue, amountOfChange, duration) {
    if (amountOfChange == 0) return initialValue;
    let s = 1.70158;
    let p = 0;
...
export function easeOutElastic(elapsed, initialValue, amountOfChange, duration) {
    ...
    let result =  a * Math.pow(2, -10 * elapsed) * Math.sin((elapsed * duration - s) * (2 * Math.PI) / p) + amountOfChange + initialValue;
    //console.log(elapsed, initialValue, amountOfChange, duration);
    return result;
}
...
function classicEase(elapsed, initialValue, amountOfChange, duration) {
    return initialValue + (amountOfChange * (elapsed/duration));
};
window.eases = {
    classicEase,easeInQuad,easeOutQuad,easeInOutQuad,easeInCubic,easeOutCubic,easeInOutCubic,easeInQuart,easeOutQuart,easeInOutQuart,easeInQuint,easeOutQuint,easeInOutQuint,easeInSine,easeOutSine,easeInOutSine,easeInBack,easeOutBack,easeInOutBack,easeInCirc,easeOutCirc,easeInOutCirc,easeInBounce,easeOutBounce,easeInOutBounce,easeInElastic,easeOutElastic
};
window.ease = [classicEase,easeInQuad,easeOutQuad,easeInOutQuad,easeInCubic,easeOutCubic,easeInOutCubic,easeInQuart,easeOutQuart,easeInOutQuart,easeInQuint,easeOutQuint,easeInOutQuint,easeInSine,easeOutSine,easeInOutSine,easeInBack,easeOutBack,easeInOutBack,easeInCirc,easeOutCirc,easeInOutCirc,easeInBounce,easeOutBounce,easeInOutBounce,easeInElastic,easeOutElastic];